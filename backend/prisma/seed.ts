...
async function main(): Promise<void> {
  ...
  await prisma.member.upsert({
    ...
    create: {
      ...
      statusKyc: 'Approved',
      skorKeanggotaan: 98,
      ktpUrl: 'https://s3.amazonaws.com/rantai-renteng-ktp/sri_ktp.jpg',
  ...
  await prisma.member.upsert({
    ...
    create: {
      ...
      statusKyc: 'Approved',
      skorKeanggotaan: 75,
      ktpUrl: 'https://s3.amazonaws.com/rantai-renteng-ktp/deni_ktp.jpg',
      simpananPokok: 100000,
  ...
  await prisma.member.upsert({
    ...
    create: {
      ...
      statusKyc: 'Approved',
      skorKeanggotaan: 45,
      ktpUrl: 'https://s3.amazonaws.com/rantai-renteng-ktp/ani_ktp.jpg',
      simpananPokok: 100000,
  ...
  await prisma.member.upsert({
    ...
    create: {
      ...
      statusKyc: 'Requested',
      skorKeanggotaan: 100,
      ktpUrl: 'https://s3.amazonaws.com/rantai-renteng-ktp/ira_ktp.jpg',
      role: 'Anggota',
      passwordHash,
    },
  });
